describe('E2E runner service', () => {
  ...
  beforeEach(() => {
    jest.resetModules();
    process.env = { ...originalEnv, NODE_ENV: 'test', E2E_RUNNER_ENABLED: 'true', E2E_DB_NAME: 'crm_frontend_e2e_test' };
  ...
  test('refuses all execution in production even if the enable flag is set', () => {
    process.env.NODE_ENV = 'production';
    expect(service.getCatalog().enabled).toBe(false);
    expect(() => service.startRun('E2E-01')).toThrow(/disabled/i);
  });
