 ...
 */
router_debt.get('/', requireAuth, debtController.getAllDebts);
 ...
 */
router_debt.get('/student/:studentId', requireAuth, debtController.getDebtsByStudent);
 ...
 */
router_debt.get('/student/:studentId/summary', requireAuth, debtController.getPaymentSummary);
 ...
 *         description: Debt not found
 */
router_debt.delete('/:id', requireAuth, debtController.deleteDebt);
