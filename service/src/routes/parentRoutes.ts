...
const { AssignParentStudentDto, CreateParentDto, IdParamDto } = require('../dtos/request.dto');
...
router.put('/:id', requireRole('superuser'), validateParams(IdParamDto), parentController.updateParent);
