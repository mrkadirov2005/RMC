 ...
 */
router_test.get('/', requireAuth, testController.getAllTests);
 ...
 */
router_test.delete('/:id', requireAuth, requireRole('superuser', 'teacher'), testController.deleteTest);
 ...
 */
router_test.delete('/questions/:questionId', requireAuth, requireRole('superuser', 'teacher'), testController.deleteQuestion);
 ...
 */
router_test.delete('/passages/:passageId', requireAuth, requireRole('superuser', 'teacher'), testController.deletePassage);
 ...
 */
router_test.get('/:testId/submissions', requireAuth, requireRole('superuser', 'teacher'), testController.getSubmissionsByTest);
 ...
 */
router_test.get('/submissions/:submissionId', requireAuth, testController.getSubmissionDetails);
 ...
 */
router_test.get('/student/:studentId/submissions', requireAuth, testController.getSubmissionsByStudent);
 ...
 */
router_test.get('/:testId/results', requireAuth, requireRole('superuser', 'teacher'), testController.getTestResults);
 ...
 */
router_test.get('/student/:studentId/results', requireAuth, testController.getStudentResults);
 ...
 */
router_test.get('/assigned/:type/:id', requireAuth, testController.getAssignedTests);
