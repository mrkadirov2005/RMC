...
export const PERMISSION_DESCRIPTIONS = {
  ...
  [PERMISSION_CODES.CRUD_TEACHER_TASK]: 'Assign, update, and delete tasks for teachers',
...
export const ROUTE_PERMISSIONS = {
  ...
  '/salary': PERMISSION_CODES.MANAGE_SALARY,
  '/assignments': PERMISSION_CODES.CRUD_ASSIGNMENT,
  '/teacher-tasks': PERMISSION_CODES.CRUD_TEACHER_TASK,
