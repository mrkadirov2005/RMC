...
type LogRow = { audit_id?: number; audit_log_id?: number; action?: string; entity_type?: string; created_at?: string; user_type?: string; details?: any };
