...
import { TEACHERS_REPOSITORY, type TeachersRepositoryPort } from '../domain/teachers.repository.port';

@Injectable()
export class TeachersService {
  constructor(@Inject(TEACHERS_REPOSITORY) private readonly repository: TeachersRepositoryPort) {}
  ...
  async get(id: number, centerId?: number) {
    ...
    if (!row) throw new NotFoundException('Teachers record not found');
    return row;
  }
