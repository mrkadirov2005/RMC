...
import { SYSTEM_REPOSITORY, type SystemRepositoryPort } from '../domain/system.repository.port';

@Injectable()
export class SystemService {
  constructor(@Inject(SYSTEM_REPOSITORY) private readonly repository: SystemRepositoryPort) {}
  ...
  async get(id: number, centerId?: number) {
    ...
    if (!row) throw new NotFoundException('System record not found');
    return row;
  }
