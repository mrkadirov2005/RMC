...
import { ARCHIVE_REPOSITORY, type ArchiveRepositoryPort } from '../domain/archive.repository.port';

@Injectable()
export class ArchiveService {
  constructor(@Inject(ARCHIVE_REPOSITORY) private readonly repository: ArchiveRepositoryPort) {}
  ...
  async get(id: number, centerId?: number) {
    ...
    if (!row) throw new NotFoundException('Archive record not found');
    return row;
  }
